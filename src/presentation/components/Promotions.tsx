...
export function Promotions() {
  ...
  return (
    <div className="p-8 pb-12 max-w-7xl mx-auto space-y-6">
      ...
      {activeTab === "promotions" ? <div className="bg-white rounded-xl border border-gray-200 py-16 text-center text-gray-400 shadow-[0_1px_4px_rgba(0,0,0,0.08)]"><Tag className="w-12 h-12 mx-auto mb-3 text-gray-200" /><p className="font-medium">No data from API</p></div> : <div className="bg-white rounded-xl border border-gray-200 shadow-[0_1px_4px_rgba(0,0,0,0.08)] overflow-x-auto"><table className="w-full text-left text-sm"><thead className="bg-gray-50 text-gray-500"><tr><th className="px-5 py-3">Code</th><th className="px-5 py-3">Discount</th><th className="px-5 py-3">Min Order</th><th className="px-5 py-3">Usage</th><th className="px-5 py-3">Expiry</th><th className="px-5 py-3">Status</th><th className="px-5 py-3 text-right">Actions</th></tr></thead><tbody><tr><td colSpan={7} className="px-5 py-16 text-center text-gray-500">No data from API</td></tr></tbody></table></div>}
    </div>
  );
}
